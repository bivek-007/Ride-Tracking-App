...
import 'package:tracking2_app/model/auth_provider.dart';
import 'package:tracking2_app/screen/home_page/home_page_screen.dart';
...
class _SignInScreenState extends State<SignInScreen> {
  ...
  void loginAndAuthenticateUser(BuildContext context) async {
    ...
    if (firebaseUser != null) {
      driversRef.child(firebaseUser.uid).once().then((DataSnapshot snapshot) {
        if (snapshot.value != null) {
          AssistantMethods.getCurrentUser();
